function equalities = newmankeuls(treatments, confidencelevel)
% equalities = newmankeuls(treatments, confidencelevel)
% each treatment is stored in one column.
% Makes newman-keuls test. H0: m1=m2=...=mk
...
for i = columns - 1: -1: 1,
    for j = 1: columns - i,
        ...
        if found == 0,
            ...
            criticalpoint = qdistinv(confidencelevel, columns * (rows - 1), i + 1);
