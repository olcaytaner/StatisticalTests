function [decision] = oa_uni_vs_multi_parametric_experiment(subfolder, metrictype1, metrictype2)
%[decision] = oa_uni_vs_multi_parametric_experiment('10fold', 'error', 'roc')
%[decision] = oa_uni_vs_multi_parametric_experiment('10fold', 'f', 'pr')
        ...
        if status1 > 0
          for l = k + 1 : algorithm_count
            ...
            if status2 > 0
              ...
              [reject2 pvalue2] = oa_hotellingt(subfolder, dataset, j, algorithm1, algorithm2, metrictype2);
              if pvalue1 < 0
                index1 = 3;
              else
                if reject1 > 0
